...
1. lokalnie na komputerze przy u¿yciu VisualStudio, IIS Expres oraz lokalnej bazy danych MsSql
...
W miejscu przeznaczonym na wskazanie lokalizacji repozytorium zdalnego nale¿y wkleiæ poni¿szy link:
GitHub: https://github.com/Hamau12/Poradnia.git
Kolejnym krokiem jest zmiana formy debugowania z Dockera na IIS Express (Opcja wyboru z listy rozwijanej w górnym menu, obok zielonego trójk¹ta), oraz zmiana ConnectionStrings w tym celu nale¿y uruchomiæ plik appsettings.Development.json i zakomentarzowaæ pierwsz¹ linijkê DefaultConnection
oraz odkomentarzowaæ drug¹ linijkê DefaultConnection
...
1. Po spe³nieniu wymagañ nale¿y wejœc do folderu umieszczonego w folderze SRP\SRP, a nastêpnie uruchomiæ ten folder w konsoli terminala. 
